...
const Sidebar = ({ users, currentUser, onSelectUser, onLogout, activeThreadUserId, availableRoles, changelog, notifications, setView, view, onMarkNotificationsAsRead }) => {
  ...
  return (
    <div className="flex flex-col w-64 h-screen bg-gray-900 text-white border-r border-violet-500/20">
      ...
      <div className="p-2 border-t border-violet-500/20">
        ...
        <div className="p-3 mt-2 text-sm bg-black/30 rounded-md"><p className="font-semibold">{currentUser.nickname}</p><p className="text-xs text-gray-400 capitalize">Rola: {currentUser.role}</p></div>
    ...
    return (
        <div className="flex flex-col flex-1 bg-gray-800">
            ...
            <main className="flex-1 p-6 overflow-y-auto space-y-8">
                ...
                {/* Zarządzanie rolami i kontraktami */}
