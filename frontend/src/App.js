...
const LoadingScreen = () => (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
        ...
        />
        <h2 className="mt-6 text-2xl font-bold" style={styles.mainGradientText}>
            Ładowanie danych...
        </h2>
      ...
      <div className="flex flex-col flex-1 bg-gray-800">
          ...
          <main className="flex-1 p-6 overflow-y-auto">
              <div className="space-y-6">
                  {contracts.length === 0 ? (
                      <p className="text-gray-400">Brak zgłoszonych kontraktów w tym wątku.</p>
                  ) : (
...
export default function App() {
  ...
  const handleAddContract = async (newContractData) => {
    ...
    try {
        ...
        alert("Wystąpił błąd podczas dodawania kontraktu. Spróbuj ponownie.");
    }
  };
